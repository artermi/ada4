...
void initialize(int ****digit_table){
...
void project_table(int ****digit_table,int digit_num,int remain,int add){
	if(add == 4){
...
void build_next(int ****digit_table,int digit_num){
	for(int i = 0; i < 7; i ++){
		for(int j = 0; j < 10; j++){
...
void build_table(int ****digit_table,const lli &bound,int & now_where){
